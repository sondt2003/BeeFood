                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                if(document.getData().get("status").toString().equalsIgnoreCase("thanhCong") && email.equalsIgnoreCase(document.getData().get("emailuser").toString())){
                        ...
                        mAdapter_recyclerView_completed.setData(list);
                        ...
                        if (list.isEmpty()){
                            empty_fragment_oder_completed_empty.setVisibility(View.VISIBLE);
                        }else{
                            empty_fragment_oder_completed_empty.setVisibility(View.INVISIBLE);
                        }
                    }
                });
